"""
    ...
    V1.0.1: Fixed treatement of optional parameters. MC, Oxford, 6 June 2014
...
def display_pixels(x, y, val, pixelsize=None, angle=None, **kwargs):
    ...
    if (angle is None) or (angle == 0):
        ...
        f = ax.pcolormesh(x, y, img, cmap=kwargs.get("cmap", sauron))
        ax.axis('image')
...
if __name__ == '__main__':
    ...
    plt.clf()
    f = display_pixels(xx[w], yy[w], counts[w], pixelsize=x[1]-x[0], angle=20)
