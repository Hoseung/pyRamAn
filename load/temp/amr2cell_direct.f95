subroutine amr2cell(repository, xmin, xmax, ymin, ymax, zmin, zmax, lmax, nx_sample, ny_sampel, nz_sample)
  !--------------------------------------------------------------------------
  ...
  character(LEN=128),INTENT(IN)::repository!,outfich,filetype='bin'
