...
module ramski_mods
  ...
  subroutine part2cube(repository,arr_range,part,ntot)
    ...
    integer::nx=0,ny=0,nz=0,idim,jdim,kdim,ncpu_read
    real(KIND=8)::t,time_tot,time_simu
    real(KIND=8)::xmin=0,xmax=1,ymin=0,ymax=1,zmin=0,zmax=1
...
program ramski_v4
  ...
  !! read RAMSES data
    ...
    integer::nstart=40,nend=470,tstart=40
...
!! == SUBROUTINES ========================================================== !!
  ...
  subroutine morton(cell,ref,ncount,lmin,lmax,nx,ny)
  ...
  subroutine writeski(skiname,nphoton,inputang,inputfov,&
