...
def plot_gal_hal(gal, hal, ind1=None, ind2=None, rscale=1.0, npix=200):
    ...
    draw.pp.pp_halo(allhal, ind=ind1, region=region, npix=npix, rscale=rscale, axes=ax, colors=500)
...
for cluster in clusters:
    ...
    plt.clf()
    centrals = plt.scatter(np.log10(mvir[ind_cen]),                 mstar[ind_cen]/mvir[ind_cen] / (info.ob/info.om),                facecolors = "red", edgecolors="red",
                label="central")
    satellites = plt.scatter(np.log10(mvir[ind_sat]),                 mstar[ind_sat]/mvir[ind_sat] / (info.ob/info.om),                 facecolors="blue", edgecolors="blue",
                label="satellite")
