...
void load_data_gal(std::fstream& fin, Meta& haloinfo,  Data2& halodata, int tothal, int is_gal){
    //int* ids;
    int iskip=0;
...
/*
void load_data(std::fstream& fin, Meta& haloinfo,  Data2& halodata, int nbodies, int tothal){
    //int* ids;
    int iskip=0;
    for (int i=0; i < tothal; i++){
        fortran_read_int(fin, halodata.np[i], 1);
...
void load(std::string& fname, Meta& haloinfo, Data2& halodata, int nbodies, int is_gal){
