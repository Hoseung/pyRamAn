...
void load_data_gal(std::fstream&,  Data&, int, int);
void load_data_gal_d(std::fstream&,  Data2&, int, int);

void allocate_data(Data&, int, int);
void allocate_data_d(Data2&, int, int);

void load(std::string&, Meta&, Data&, int, int);
void load_d(std::string&, Meta2&, Data2&, int, int);
