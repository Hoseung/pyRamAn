 ...
 * Generation date: Thu Mar  9 13:49:24 2017
 * $Revision:$
 * $Date:$
...
/* See f2py2e/rules.py */
extern void F_FUNC_US(count_tree,COUNT_TREE)(string,int*,int*,int*,int*,size_t);
extern void F_FUNC_US(load_tree,LOAD_TREE)(string,int*,int*,int*,float*,int*,float*,int*,int*,int*,int*,size_t);
/*eof externroutines*/
...
n_halos_all,flist_index,slist_index = count_tree(fn,big_run)\n\nWrapper for ``count_tree``.\
\n\nParameters\n----------\n"
...
#endif
/*callfortranroutine*/
        (*f2py_func)(fn,&n_halos_all,&flist_index,&slist_index,&big_run,slen(fn));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
    ...
    capi_buildvalue = Py_BuildValue("iii",n_halos_all,flist_index,slist_index);
/*closepyobjfrom*/
...
fatherid,fatheridx,sonid,fathermass,i_arr,f_arr = load_tree(fn,n_halos_all,n_all_fathers,n_all_sons,big_run)\n\nWrapper for ``load_tree``.\
\n\nParameters\n----------\n"
"fn : input string(len=256)\n"
...
static PyObject *f2py_rout_cnt_tree_load_tree(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(string,int*,int*,int*,float*,int*,float*,int*,int*,int*,int*,size_t)) {
  PyObject * volatile capi_buildvalue = NULL;
  volatile int f2py_success = 1;
/*decl*/
  ...
  int big_run = 0;
  PyObject *big_run_capi = Py_None;
  static char *capi_kwlist[] = {"fn","n_halos_all","n_all_fathers","n_all_sons","big_run",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOO:cnt_tree.load_tree",\
    capi_kwlist,&fn_capi,&n_halos_all_capi,&n_all_fathers_capi,&n_all_sons_capi,&big_run_capi))
    return NULL;
/*frompyobj*/
...
#endif
/*callfortranroutine*/
        (*f2py_func)(fn,fatherid,fatheridx,sonid,fathermass,i_arr,f_arr,&n_halos_all,&n_all_fathers,&n_all_sons,&big_run,slen(fn));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*end of pyobjfrom*/
    CFUNCSMESS("Building return value.\n");
    capi_buildvalue = Py_BuildValue("NNNNNN",capi_fatherid_tmp,capi_fatheridx_tmp,capi_sonid_tmp,capi_fathermass_tmp,capi_i_arr_tmp,capi_f_arr_tmp);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
    } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
