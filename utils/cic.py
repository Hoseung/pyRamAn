...
def cic(value, x, nx, y=None, ny=1, z=None, nz=1,
    ...
    def update_field_vals(field, totalweight, a, b, c, value, debug=True, norm_integer=False):
    ...
    cymodule.update_field_vals(field, totalweight, x1, y1, z1, value, debug=debug)
    cymodule.update_field_vals(field, totalweight, x2, y1, z1, value, debug=debug)
    if y is not None:
        cymodule.update_field_vals(field, totalweight, x1, y2, z1, value, debug=debug)
        cymodule.update_field_vals(field, totalweight, x2, y2, z1, value, debug=debug)
        if z is not None:
            cymodule.update_field_vals(field, totalweight, x1, y1, z2, value, debug=debug)
            cymodule.update_field_vals(field, totalweight, x2, y1, z2, value, debug=debug)
            cymodule.update_field_vals(field, totalweight, x1, y2, z2, value, debug=debug)
            cymodule.update_field_vals(field, totalweight, x2, y2, z2, value, debug=debug)
